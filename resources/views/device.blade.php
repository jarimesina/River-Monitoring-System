...
<h1 class="page-title mt-3">About the Device</h1> 
    <div class="cont text-center mx-3 mt-3">
        ...
        <p class="para text-justify">This water level meter was designed using the concept of Boyle's Law. A barometric pressure sensor is attached to a ____ diameter pipe with an opening facing downward. </p>
